...
**Candidate id:** `Challenger_P1BASE_p3smoke_01`
...
**Generated:** 2026-07-14T14:05:17.7333559Z
**Signer:** dlr_p3_smoke

## Evidence

- [x] Same tester contract ($400 Â· every tick Â· ProfitInPips=0) - assumed from AER launch.ini
- [x] **G1:** PF >= PRODUCTION **and** max DD <= PRODUCTION
  - Candidate PF **1.38** vs bench **1.36** -> ok
  - Candidate DD **17.5%** vs bench **18%** -> ok
  - Gate: **PASS**
