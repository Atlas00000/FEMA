...
**Generated:** 2026-07-14T13:32:51.8981738Z
**Signer:** dlr_p1_smoke
...
- [ ] **G1:** PF >= PRODUCTION **and** max DD <= PRODUCTION
  - Candidate PF **1.4316** vs bench **1.36** -> ok
  - Candidate DD **18.13%** vs bench **18%** -> FAIL
  - Gate: **FAIL**
...
- [x] Human sign-off: **dlr_p1_smoke** / 2026-07-14
