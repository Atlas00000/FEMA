...
**Candidate id:** `DLR_P1_VERIFY_DUMMY`
...
**Generated:** 2026-07-14T13:36:32.8027210Z
**Signer:** verify_p01
...
- [ ] **G1:** PF >= PRODUCTION **and** max DD <= PRODUCTION
  - Candidate PF **1.2** vs bench **1.36** -> FAIL
  - Candidate DD **20%** vs bench **18%** -> FAIL
  - Gate: **FAIL**
...
- [x] Human sign-off: **verify_p01** / 2026-07-14
